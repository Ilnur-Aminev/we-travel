...
const NavigationHeader: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const previousPathWasHomepage = prev === rootPath || (prev && prev.includes('/page/'));
    const currentPathIsHomepage = location.pathname === rootPath || location.pathname.includes('/page/');
